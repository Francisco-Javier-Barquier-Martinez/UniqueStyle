<nav class="navbar navbar-expand-md navbar-light">
  <a class="navbar-brand text-uppercase" href="{{ route('products.productosIndex') }}"><span class="border-red pe-2">Unique</span><span class="text-danger">Style</span></a>
    ...
    <div class="navbar-nav text-center">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarCollapse">
          ...
          <a class="dropdown-item nav-link" href="{{ route('user.edit', session('id') ) }}">Perfil <i class="fas fa-id-card"></i></a>
        </div>
      </li>
      @else
      ...
      <li class="nav-item dropdown mx-auto">
        ...
        <div id="carrito" class="dropdown-menu p-3" aria-labelledby="navbarCollapse">
          ...
          <div class="row">
            <!-- VACIAR CARRITO -->
            <div class="col-md-6"><a href="#" id="boton-vaciar" class="btn btn-primary btn-block border-0"><i class="fas fa-trash-alt"></i></a></div>
            <!-- PANTALLA CONFIRMAR PRODUCTOS PARA REALZIAR PEDIDO -->
            <div class="col-md-3"><a href="{{ route('products.pantallaCompra') }}" id="procesar-pedido" class="btn btn-danger btn-block border-0"><i class="fas fa-credit-card"></i></a></div>
          </div>
        </div>
      </li>
